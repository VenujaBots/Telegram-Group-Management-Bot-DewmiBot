...
class Config(object):
    ...
    TOKEN = "2044832605:AAETnxQJzGyEYKSFXjxdLJZngle8SgoOmDk"  # This var used to be API_KEY but it is now TOKEN, adjust accordingly.
    ...
    REDIS_URI = "redis-11871.c294.ap-northeast-1-2.ec2.cloud.redislabs.com:11871"
    LOAD = []
    ...
    BAN_STICKER = "CAACAgUAAxkBAAIwdWGfdOcEXzrsMDNqnnvF0gVm98LIAAJKBAACA7oYVMX7DjQu-gRbIgQ"  # banhammer marie sticker id, the bot will send this sticker before banning or kicking a user in chat.
